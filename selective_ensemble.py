...
from test import test_be_lst_by_date, test_be_lst_pvalue_by_date
from nn import *
import os
...
#         soup_lst = ['BE_batch256_hidden128_lr0.0005_clf_3','BE_batch256_hidden128_lr0.0005_clf_0','BE_batch256_hidden128_lr0.0005_clf_3','BE_batch256_hidden128_lr0.0005_clf_5','BE_batch256_hidden128_lr0.0005_clf_9']
...
#         _, ret_lst, _, = test_be_lst_pvalue_by_date(model, net_lst, test_date, dataset, stock_lst, feature_lst, target,
#                                                       25, 4, 'clf', criterion)
#         print('test return:{}'.format(sum(ret_lst)))

#         _, ret_lst, _, = test_be_lst_by_date(model, net_lst, test_date, dataset, stock_lst, feature_lst, target,
#                                                       25, 4, 'clf', criterion)
#         print('test return:{}'.format(sum(ret_lst)))
...
if __name__ == '__main__':
    ...
    if dataset == 'acl18':
        # soup_lst = ['BE_batch256_hidden128_lr0.0005_clf_3','BE_batch256_hidden128_lr0.0005_clf_0','BE_batch256_hidden128_lr0.0005_clf_2','BE_batch256_hidden128_lr0.0005_clf_4','BE_batch256_hidden128_lr0.0005_clf_5','BE_batch256_hidden128_lr0.0005_clf_6','BE_batch256_hidden128_lr0.0005_clf_7','BE_batch256_hidden128_lr0.0005_clf_8','BE_batch256_hidden128_lr0.0005_clf_9','BE_batch256_hidden128_lr0.0005_clf_1',
        # 'BE_batch256_hidden128_lr0.0002_clf_0','BE_batch256_hidden128_lr0.0002_clf_1','BE_batch256_hidden128_lr0.0002_clf_2','BE_batch256_hidden128_lr0.0002_clf_3','BE_batch256_hidden128_lr0.0002_clf_4','BE_batch256_hidden128_lr0.0002_clf_5','BE_batch256_hidden128_lr0.0002_clf_6','BE_batch256_hidden128_lr0.0002_clf_7','BE_batch256_hidden128_lr0.0002_clf_8','BE_batch256_hidden128_lr0.0002_clf_9']
        soup_lst = ['BE_batch32_hidden128_lr0.0005_clf_0','BE_batch32_hidden128_lr0.0005_clf_1','BE_batch32_hidden128_lr0.0005_clf_2','BE_batch32_hidden128_lr0.0005_clf_3','BE_batch32_hidden128_lr0.0005_clf_4',
        'BE_batch32_hidden128_lr0.0005_clf_5','BE_batch32_hidden128_lr0.0005_clf_6','BE_batch32_hidden128_lr0.0005_clf_7','BE_batch32_hidden128_lr0.0005_clf_8','BE_batch32_hidden128_lr0.0005_clf_9',
        'BE_batch128_hidden128_lr0.0002_clf_0','BE_batch128_hidden128_lr0.0002_clf_1','BE_batch128_hidden128_lr0.0002_clf_2','BE_batch128_hidden128_lr0.0002_clf_3','BE_batch128_hidden128_lr0.0002_clf_4',
        'BE_batch128_hidden128_lr0.0002_clf_5','BE_batch128_hidden128_lr0.0002_clf_6','BE_batch128_hidden128_lr0.0002_clf_7','BE_batch128_hidden128_lr0.0002_clf_8','BE_batch128_hidden128_lr0.0002_clf_9']
        model = 'BE_batch{}_hidden{}_lr{}_clf'.format(128,128,str(1e-4))
        seed = 0
        net, stock_lst, feature_lst, target, valid_date, criterion = get_valid_setting(dataset, model, seed)
        best_valid_profit = -1    
